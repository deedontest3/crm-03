...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "flex min-w-0 flex-col-reverse items-stretch gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end sm:space-x-0",
      className
    )}
    {...props}
  />
