    	...
    	extend: {
    		colors: {
    			...
    			stage: {
    				...
    				'verbal-approval': 'hsl(var(--stage-verbal-approval))',
    				'verbal-approval-foreground': 'hsl(var(--stage-verbal-approval-foreground))',
    				...
    				'hold-foreground': 'hsl(var(--stage-hold-foreground))',
